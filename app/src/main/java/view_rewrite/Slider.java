...
/**
 * Created by zhuchao on 7/18/15.
 */
public class Slider extends SliderCustomer{

    private int backgroundColor = Color.parseColor("#00b7ee");
    private Ball   ball;
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (value != newValue) {
                        ...
                        if (onValueChangedListener != null)
                            onValueChangedListener.onStopTrackingTouch(newValue);
                    }
                    // move ball indicator
                    float x = event.getX();
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate == false) {
                ...
                numberIndicator.numberIndicator.setText(PlayerViewTest.getTime(value*total_time/max) + "");
            }
